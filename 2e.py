...
def sequence_cyclopeptide(spectrum):
	spectrum_mass = spectrum[-1] # TODO is this right?
	queue = set([tuple([0])])
	solution = []
	while queue:
		queue = expand(queue)
		...
		for peptide in queue:
			if sum(peptide) == spectrum_mass:
				#print peptide, get_spectrum(peptide), spectrum
...
def is_consistent(peptide, spectrum): # TODO is this right?
...
def get_subpeptides(peptide): # TODO is this right?
	if peptide[0] == 0:
		peptide = peptide[1:]
	subs = [(0,)]
...
"""
print get_subpeptides((0,1,))
print get_subpeptides((0,1,2))
print get_subpeptides((0,1,2,3))
print get_subpeptides((0,1,2,1))
print get_subpeptides((0,1,1,1))
print get_subpeptides((0,1,2,1,2))

print get_spectrum((0,1,))
print get_spectrum((0,1,2))
print get_spectrum((0,1,2,3))
print get_spectrum((0,1,2,1))
print get_spectrum((0,1,1,1))
print get_spectrum((0,1,2,1,2))
"""
