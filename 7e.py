...
while True:
	max_item_index = max_index(LCP)
	if SA[max_item_index] > len(A) or SA[max_item_index-1] > len(A):
		if SA[max_item_index] < len(A):
			print A[SA[max_item_index]:SA[max_item_index]+LCP[max_item_index]]
			break
		if SA[max_item_index-1] < len(A):
			print A[SA[max_item_index-1]:SA[max_item_index-1]+LCP[max_item_index]]
			break
	LCP[max_item_index] = 0
